...
function builder_add_theme_feature_option( $feature, $name, $description, $default_enabled = true ) {
	...
	$builder_theme_feature_options[$feature] = compact( 'name', 'description', 'default_enabled' );
}
...
function builder_theme_supports( $feature ) {
	global $wp_theme_options;
