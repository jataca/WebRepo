	...
	class ITStorage {
		...
		function load( $merge_defaults = true ) {
			if ( true !== $this->_loaded )
				ITError::fatal( 'early_call:ITStorage:load', 'ITStorage has not fully loaded yet. You must wait until after the init action priority -10.' );
		...
		function save( $data ) {
			if ( true !== $this->_loaded )
				ITError::fatal( 'early_call:ITStorage:save', 'ITStorage has not fully loaded yet. You must wait until after the init action priority -10.' );
		...
		function remove() {
			if ( true !== $this->_loaded )
				ITError::fatal( 'early_call:ITStorage:remove', 'ITStorage has not fully loaded yet. You must wait until after the init action priority -10.' );
