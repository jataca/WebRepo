...
if ( ! class_exists( 'LayoutModuleFooter' ) ) {
	class LayoutModuleFooter extends LayoutModule {
		...
		function LayoutModuleFooter() {
			$this->_name = _x( 'Footer', 'module', 'it-l10n-Builder' );
			$this->_description = __( 'This module adds a place for the footer to render. Most layouts will have this module at the bottom of the layout.', 'it-l10n-Builder' );
